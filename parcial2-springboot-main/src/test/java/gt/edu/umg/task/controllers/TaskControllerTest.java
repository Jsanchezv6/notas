...
class TaskControllerTest {
    ...
    void testFindById() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(taskController)
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":123,\"title\":\"Title\",\"description\":\"The characteristics of someone or something\",\"dueDate\":0}"));
    }
    ...
    void testModifyTask() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(taskController)
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":123,\"title\":\"Tittle\",\"description\":\"The characteristics of someone or something\",\"dueDate\":0}"));
    }
}